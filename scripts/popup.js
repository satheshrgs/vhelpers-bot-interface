...
var a="<div id='myModal' class='popupmodal'>";
  var b="<div class='popupmodal-content' id='myModal-content'>";
    var c="<span class='popupclose' onclick='spanclick()'>&times;</span>";
		var d="<b><p><center><h1>VHelpers Personal Assistant</h1><hr><br>Bored With Hike Natasha???   <h2>Chat with our <a href='http://vhelpers.herokuapp.com/mobile' target='_blank'>InfoBot</a></h2></center></p>";
  var e="</div>"
var f="</div>"
$("body").append(a);
$("#myModal").append(b);
